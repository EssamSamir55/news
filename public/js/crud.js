function store(url, data) { //عملية تخزين البيانات
    axios.post(url, data)
...
function storeRoute(url, data) { //نستخدمها لعملية التعديل وتعديل الصور والملفات
    axios.post(url, data, {
    headers: {
...
function update (url, data, redirectUrl) { //تعديل البيانات فقط لا تعدل الصور والملفات
    axios.put( url, data)
...
function confirmDestroy(url, td) { //حذف عنصر معين 
    Swal.fire({
