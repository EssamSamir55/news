        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Show New sliders</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form>
              <div class="card-body">
                ...
                <div class="form-group col-md-6">
                  ...
                  <input type="text" class="form-control" id="title" name="title" value="{{$sliders->title}}" placeholder="Enter Name of sliders" disabled>
                </div>
           </div>
