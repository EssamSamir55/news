...
<head>
  ...
  <link rel="shortcut icon" href="{{ asset('storage/images/radio-solid.svg') }}" type="image/x-icon">

  <!-- Google Font: Source Sans Pro -->
  <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700&display=fallback">
  <!-- Font Awesome -->
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.3.0/css/all.min.css" integrity="sha512-SzlrxWUlpfuzQ+pcUCosxcglQRNAq/DZjVsC0lE40xsADsfeQoEypE+enwcOiGjk/bSuGGKHEyjSoQ1zVisanQ==" crossorigin="anonymous" referrerpolicy="no-referrer" />  <!-- Ionicons -->
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
            ...
            <img src="{{asset('storage/images/admin/'.$admin->user->image)}}" class="img-circle elevation-2" alt="User Image">
            @else
            <img src="{{ asset('images/userSolid.png') }}" class="img-circle elevation-2" alt="User Image">
            @endif

            @elseif(Auth::guard('author')->id())
            @if(auth('author')->user()->images !='')
            <img src="{{asset('storage/images/author/'.$author->user->image ?? "")}}" class="img-circle elevation-2" alt="User Image">
            @else
            <img src="{{ asset('images/userSolid.png') }}" class="img-circle elevation-2" alt="User Image">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ route('view.home') }}" class="nav-link active">
