          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <form class="mt-5">
                ...
                <input type="text" class="form-control" id="firstname" name="firstname" placeholder="Enter First Name of Viewer ">
                </div>
                <div class="form-group col-md-6">
                <label for="lastname">Last Name of Viewer</label>
                <input type="text" class="form-control" id="lastname" name="lastname" placeholder="Enter Last Name of Viewer">
                </div>
            </div>
