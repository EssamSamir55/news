            ...
            <div class="col-lg-4 mb-4">
                <div class="card h-100">
                    ...
                    <div class="card-footer">
                        <a href="{{ route('detailes', $article->id) }}" class="btn btn-primary">Learn More</a>
                    </div>
                </div>
            </div>
            @endforeach
...
<section class="gray-sec">
    <div class="container">
        ...
        <div align="center"><a class="btn btn-success" href="{{ route('allNews' , $category->id) }}">more news</a></div>
    </div>
</section>
@endforeach
